...
exports.download = async (req: any, res: any) => {
...
exports.mediaController = async (req: any, res: any) => {
  ...
  try {
    ...
    if (url.match("youtube.com")) {
      ...
      await ytdl.getInfo(videoID).then((info: any) => {
        const link = info.formats.filter((vl: any) => vl.itag == 18)[0].url;
